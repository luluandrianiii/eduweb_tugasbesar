...
<body>
    ...
    <div class="banner">
        <div class="detail">
            <div class="title">
                <a href="index.php">beranda</a><span><i class="bx bx-chevron-right">tutor</i></span>
            </div>
            <h1>daftar menjadi tutor sekarang</h1>
    ...
    <section class="teachers">
        ...
        <div class="box-container">
            <div class="box">
                <h3>Menjadi Tutor</h3>
                <p>Kami membuka kesempatan untuk semuanya bisa menjadi tutor. Daftar sekarang juga dan bagikan
                    ilmu yang kalian punya!!!
                    Tunggu apalagi ayo daftar jadi tutor</p>
                <a href="admin/register.php" class="btn">Daftar Jadi Tutor</a>
            </div>
            <?php

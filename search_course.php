...
<body>
    ...
    <div class="banner">
        <div class="detail">
            <div class="title">
                <a href="index.php">beranda</a><span><i class="bx bx-chevron-right"> cari kursus</i></span>
            </div>
            <h1>berbagai macam kursus</h1>
    ...
    <section class="courses">
        ...
        <div class="box-container">
            <?php
                 if (isset($_POST['search_course_btn']) && isset($_POST['search_course']) && !empty($_POST['search_course'])) {
            ...
            <?php
                     ...
                     echo '<p class="empty">cari yang lainnya</p>';
                }
            ?>
        </div>
    </section>
